...
return {
  ...
  -- bookmarks plugin - didn't work out of the box
  -- {
  ...
  --
  {
    ...
    config = function() require("waypoint").setup {} end,
  },
  ...
  },
  {
    ...
    config = function()
      ...
      local function get_fortune()
        if command_exists "fortune" and command_exists "cowsay" then
          local handle = io.popen "fortune -s computers science | cowsay"
          if handle then
            local result = handle:read "*a"
            handle:close()
            return result
   ...
   ╰─────────────────────────────╯
      ...
      local logo1 = [[
 ________   _______   ________        ___  ___  _____ ______      
|\   ___  \|\  ___ \ |\   __  \      |\  \|\  \|\   _ \  _   \    
\ \  \\ \  \ \   __/|\ \  \|\  \     \ \  \ \  \ \  \\\__\ \  \   
 \ \  \\ \  \ \  \_|/_\ \  \\\  \  __ \ \  \ \  \ \  \\|__| \  \  
  \ \  \\ \  \ \  \_|\ \ \  \\\  \|\  \\_\  \ \  \ \  \    \ \  \ 
   \ \__\\ \__\ \_______\ \_______\ \________\ \__\ \__\    \ \__\
    \|__| \|__|\|_______|\|_______|\|________|\|__|\|__|     \|__|
      ]]
...
░▒▓█▓▒░░▒▓█▓▒░▒▓████████▓▒░▒▓██████▓▒░ ░▒▓██████▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░ 
 ...
 ██████   ██  ███████████████   ██ █████████████████
      ...
      local header_hl = {
        ...
        { { "Red", 1, 1 } },
        { { "Red", 1, 1 } }, -- Empty lines
        { { "AlphaHeader0_0", 43, 45 },
          { "AlphaHeader0_1", 46, 48 }
        }, -- Line 10
        { -- Line 11
          { "AlphaHeader1_0", 7, 22 },
          { "AlphaHeader1_1", 41, 45 },
      ...
      vim.api.nvim_set_hl(0, "AlphaHeader0_0", { fg = "#386c3f" })
      vim.api.nvim_set_hl(0, "AlphaHeader0_1", { fg = "#a6c9ab" })
      ...
      -- local function footer() return "Footer Text" end

      -- dashboard.section.footer.val = vim.split("\n\n" .. getGreeting "Lazy", "\n")
      dashboard.section.footer.val = vim.split(get_fortune(), "\n")

      -- local function get_day_of_week() return os.date "%A" end
      --
